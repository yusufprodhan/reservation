            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h1>Welcome to PIX Clipping!</h1>
                        <p class="font-size-18">Your successfully registered in our system. Please check your respective email box for verify your email.</p>
