                ...
                <div class="swiper-container min-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-1.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-2.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-3.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-4.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-5.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-6.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-7.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                        <div class="swiper-slide slide-center item">
                            <img src="/front-assets/images/gallery-8.jpg" class="fit-image w-85" alt="Fit Image">
                        </div>
                    </div>
                </div>
            </div>
