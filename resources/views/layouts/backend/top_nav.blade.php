            ...
            <div class="float-end">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        @else
                            <a class="dropdown-item" href="{{route('home.profile')}}"><i class="bx bx-user font-size-16 align-middle me-1"></i>
                        @endif
                            Profile</a>
...
{{--                            Lock screen</a>--}}
            ...
            <div>
                ...
                <div class="navbar-brand-box">
                    <a href="{{auth()->user()->is_admin ? route('admin') : route('home')}}" class="logo logo-dark">
                                    <span class="logo-sm">
                                        <img src="/assets/images/logo-light.jpeg" alt="" height="40">
                                    </span>
                        <span class="logo-lg">
                    ...
                    <a href="{{auth()->user()->is_admin ? route('admin') : route('home')}}" class="logo logo-light">
                                    <span class="logo-sm">
                                        <img src="/assets/images/logo-light.jpeg" alt="" height="20">
                                    </span>
                        <span class="logo-lg">
                                        <img src="/assets/images/logo-light.jpeg" alt="" height="60">
                                    </span>
                    </a>
                </div>
                ...
                @if(auth()->user()->is_user)
                    <a href="{{route('home.order.create')}}" class="btn btn-outline-success"
                       style="position: relative;top: 20px;"><i class="mdi mdi-cart"></i> Place Order
                    </a>
                    <button type="button" class="btn btn-outline-danger"
                       style="position: relative;top: 20px;"><i class="fas fa-id-card "></i> {{auth()->user()->uid}}
                    </button>
                @endif
                <!-- App Search-->
